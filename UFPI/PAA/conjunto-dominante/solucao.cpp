...
int main(int argc, char const *argv[]){
    ...
    for (int i = 1; i <= 6; i++)
    {
        ...
        // cout << "Conjunto dominante partindo de " << i << endl;
        for(auto x : conjuntoDominante){
            // cout << x << " ";
        }
        cout << endl;

        dominados.clear();
        dominados.erase(dominados.begin(), dominados.end());
        conjuntoDominante.erase(conjuntoDominante.begin(), conjuntoDominante.end());
        conjuntoDominante.clear();
    }
